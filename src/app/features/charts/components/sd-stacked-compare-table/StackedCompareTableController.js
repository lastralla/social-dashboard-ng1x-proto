...
// TODO this was duplicated from CompareTableController, refactor out common code

let _$sce;

class StackedCompareTableController {

  /* @ngInject */
  constructor($sce, NOT_AVAIL_STR) {
    _$sce = $sce;
...
export { StackedCompareTableController };
...
function updateSets(metricSets, data) {
  metricSets.forEach((set) => {
    ...
    let dataObj = {
      ...
      callToAction: _$sce.trustAsHtml(set.callToAction)
    };
